# app.py — Master Scoring Model (Simplified • Pro)
...
# ─────────────────────────────────────────────────────────────
# Sidebar — Parameter & Gewichte (nur die nötigen)
# ─────────────────────────────────────────────────────────────
st.sidebar.header("⚙️ Scoring-Parameter (schlank)")
y_floor=st.sidebar.number_input("Yield-Floor", min_value=0.0, max_value=0.5, value=0.04, step=0.005, format="%.3f")
y_scale=st.sidebar.number_input("Yield-Scale", min_value=0.001, max_value=1.0, value=0.04, step=0.005, format="%.3f")
invert_52w=st.sidebar.checkbox("52W invertieren (nah am Low = besser)", value=True)
pos_gamma =st.sidebar.slider("52W-Gamma", 0.3, 3.0, 1.5, 0.1)
